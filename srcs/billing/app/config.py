...
class BillingConfig:
	...
	def as_dict() -> dict[str, object]:
		return {
			...
			"BILLING_RABBITMQ_HEARTBEAT": int(_env("BILLING_RABBITMQ_HEARTBEAT", "30")),
			"BILLING_RABBITMQ_BLOCKED_CONNECTION_TIMEOUT": int(
				_env("BILLING_RABBITMQ_BLOCKED_CONNECTION_TIMEOUT", "30")
			),
			"BILLING_CONSUMER_RECONNECT_DELAY": int(_env("BILLING_CONSUMER_RECONNECT_DELAY", "5")),
